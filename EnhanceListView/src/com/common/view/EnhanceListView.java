...
public class EnhanceListView extends ListView implements OnScrollListener {
    ...
    private boolean isDisplayEmptyView = false;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int padding = getResources().getDimensionPixelSize(R.dimen.enhance_list_empty_text_padding);
        int textSize = getResources().getDimensionPixelSize(R.dimen.enhance_list_empty_text_size);
        mEmptyView.setPadding(0, padding, 0, padding);
        mEmptyView.setGravity(Gravity.CENTER);
        mEmptyView.setTextSize(textSize);
        mEmptyView.setText(R.string.enhance_list_empty_data);
    ...
    public void setAdapter(final ListAdapter adapter) {
        ...
        if (!isDisplayEmptyView && (getAdapter() == null || getAdapter().isEmpty())) {
            showEmptyView();
